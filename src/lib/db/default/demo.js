export const demo_app = {
  ...
  endpoints: [
    ...
    },
    {
      ...
      cost: 0.000001,
      keywords: "",
      code: "let uf = ofapi.uFetchAutoEnvironment.create('/api/demo/ofapi/javascript/example03/auto');\nlet r1 = await uf.GET();\n\n$_RETURN_DATA_ = await r1.json();\n",
      cache_time: 0,
      createdAt: "2025-11-21T22:04:52.792Z",
