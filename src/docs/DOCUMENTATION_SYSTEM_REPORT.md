...
├── dependencies/
│   └── universal-fetch.md                 # Concrete guide for the @edwinspire/universal-fetch package
└── handlers/
...
| **FETCH** | Fetch | Upstream HTTP URL | Acts as an HTTP proxy/forwarder. Integrates `@edwinspire/universal-fetch`. |
